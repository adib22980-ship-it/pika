...
TELEGRAM_TOKEN = os.getenv("TELEGRAM_TOKEN", "8954943501:AAHwf5LCKngiN3v8GLvfS39zA_DFwTZbdbs").strip()
...
def get_ai_response(message, user_name, is_abuse):
    ...
    return "Tujhe kya problem hai" if is_abuse else "Haan ji bolo"
...
def process_message(update):
    ...
    should_respond = chat_type == "private" or is_abuse
    ...
    if "group" in chat_type:
        ...
        if (
            ...
            or replied_from.get("username", "").lower() == BOT_USERNAME.lower()
        ):
            should_respond = True
